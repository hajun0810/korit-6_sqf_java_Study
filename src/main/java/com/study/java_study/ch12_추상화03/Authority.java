...
/*
    ...
    3. 무조건 상수만 정의 할 수 있다.
    4. 일반 메소드(맴버메소드)를 정의하기 위해서는 default 키워드를 사용하여야 한다.
    5. 추상 메소드를 정의 할 때 abstract 키워드를 생략할 수 있다.
    6. 인터페이스 안에 정의되는 모든 상수와 메소드들은 public 점근 지정자를 사용한다.
 */
public interface Authority {
    // public static final 이 생략 되어 있음
    String DEFAULT_ROLE = "ROLE_USER";

    // public abstract 가 생략 되어 있음
    String getAuthority();
