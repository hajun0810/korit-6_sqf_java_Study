...
public class StreamMain {
    public static void main(String[] args) {
        ...
        */
        ...
        // peek : 스트림을 실행하는 동안 결과를 확일할때 사용 됨
       ...
       List<Integer> filteringNumberList =  numberList.stream()
        ...
        List<Integer> sortedNumberList = numberList.stream()
                // 오름차순 정렬 : .sorted((o1, o2) -> o1 - o2)
                .sorted((o1, o2) -> o2 - o1) // 역정렬
                .collect(Collectors.toList());
       ...
       // namesStream.sorted().forEach(name -> System.out.println(name));
        namesStream.sorted((o1, o2) ->String.CASE_INSENSITIVE_ORDER.compare(o2,o1))
